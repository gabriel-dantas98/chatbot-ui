...
AS $$
DECLARE
  project_url TEXT := 'https://oqztimqwtdigjhneftox.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xenRpbXF3dGRpZ2pobmVmdG94Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyMDA2MTU5NCwiZXhwIjoyMDM1NjM3NTk0fQ.eijmM6xatBXCgaQiUD_DlcvXfFd3TOGK-N-XcdC7fQg'; -- full access needed for http request to storage
